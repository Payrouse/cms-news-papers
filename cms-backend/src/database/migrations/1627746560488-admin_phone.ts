...
export class adminPhone1627746560488 implements MigrationInterface {
    name = 'adminPhone1627746560488'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "administrators" DROP COLUMN "phone_number"`);
        await queryRunner.query(`ALTER TABLE "administrators" ADD "phone_number" character varying(13) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "administrators" ADD CONSTRAINT "UQ_cdebf73ab236f3b38fa1b3e2373" UNIQUE ("administrator_id")`);
        await queryRunner.query(`ALTER TABLE "articles" ALTER COLUMN "status" SET DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "administrators" DROP COLUMN "phone_number"`);
        await queryRunner.query(`ALTER TABLE "administrators" ADD "phone_number" character varying(10) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "administrators" ADD CONSTRAINT "FK_cdebf73ab236f3b38fa1b3e2373" FOREIGN KEY ("administrator_id") REFERENCES "users"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
