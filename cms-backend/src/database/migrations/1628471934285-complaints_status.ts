...
export class complaintsStatus1628471934285 implements MigrationInterface {
    name = 'complaintsStatus1628471934285'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "complaints" ADD "status" smallint NOT NULL`);
