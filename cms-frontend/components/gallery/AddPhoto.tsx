const AddPhoto = ({ showUploader }: any) => {
  return (
    <div
      className="w-24 h-24 rounded-md shadow-sm mx-2 my-2 cursor-pointer border-2 border-gray-400 border-dashed flex flex-col items-center justify-center"
      onClick={() => {
        showUploader();
      }}
    >
      <label className="cursor-pointer text-center font-semibold">
        Add Picture to Galery
      </label>
